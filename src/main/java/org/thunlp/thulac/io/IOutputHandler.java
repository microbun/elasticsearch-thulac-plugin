...
public interface IOutputHandler extends IProgramStateListener {
	/**
	 * Handles the {@link java.util.List} of {@link org.thunlp.thulac.data.TaggedWord} generated by the segmentation
	 ...
	 *
	 * @param words
	 * 		The {@link java.util.List} of {@link org.thunlp.thulac.data.TaggedWord} generated processing one line segment.
	 * @param segOnly
	 ...
	 * This method is invoked before {@link #handleLineSegment(java.util.List, boolean, char)}.
	 */
	 ...
	 * This method is invoked after {@link #handleLineSegment(java.util.List, boolean, char)}.
	 */
