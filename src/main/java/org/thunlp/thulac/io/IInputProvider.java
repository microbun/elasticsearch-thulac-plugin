...
/**
 * An interface used to provide input for {@link org.thunlp.thulac.Thulac}. Implementations of this
...
public interface IInputProvider extends IProgramStateListener {
	/**
	 * Provide a {@link java.util.List} of {@link String} which contains the input for the
	 ...
	 * an EOF and the program will terminate. A {@link java.util.List} is used because it is
