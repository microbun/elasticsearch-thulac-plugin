...
public class Thulac {
	...
	/**
	 * Run the segmentation program with argument {@code segOnly}, taking input from the
	 * given {@link java.io.File} and output the segmented return to a given {@link java.io.File}.<br>
	...
	/**
	 * Run the segmentation program with argument {@code segOnly}, taking input from the
	 * given {@link java.io.File} and output the segmented return to a given {@link java.io.File}.
	 *
	 * @param input
	 * 		The input {@link java.io.File}.
	 * @param output
	 * 		The output {@link java.io.File}.
	 * @param segOnly
	 * 		Whether to output only segments.
	 *
	 * @throws java.io.IOException
