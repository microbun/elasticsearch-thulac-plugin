...
/**
 * A postprocess pass which identifies <i>Dictionary Verbs</i> and <i>Directional Verbs</i>.
 *
 * @see <a href="https://en.wikipedia.org/wiki/Modal_verb">Dictionary Verb</a>
 * @see <a href="https://zh.wikipedia.org/wiki/%E8%83%BD%E6%84%BF%E5%8A%A8%E8%AF%8D">
 * Dictionary Verb in Chinese</a>
...
public class VerbPass implements IPostprocessPass {
	/**
	 * {@link org.thunlp.thulac.data.Dat} file containing word list of Dictionary Verbs.
	 */
	private Dat vM;
	/**
	 * {@link org.thunlp.thulac.data.Dat} file containing word list of Directional Verbs.
	 */
	private Dat vD;
	/**
	...
	/**
	 * Within two adjacent verbs, only the first one might be a Dictionary Verb and only the
