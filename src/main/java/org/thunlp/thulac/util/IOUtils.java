...
/**
 * A class which provides static utility methods used dealing with {@link org.thunlp.thulac.io.IInputProvider}
 * and {@link IOutputHandler}. Some of them construct instances of {@link org.thunlp.thulac.io.IInputProvider}
 * and {@link IOutputHandler}, hiding the implementation details from the user. Others
 * can be used within implementations of {@link org.thunlp.thulac.io.IInputProvider} and
 * {@link IOutputHandler}, avoiding code duplicates.
 *
 * @see org.thunlp.thulac.io.IInputProvider
 * @see IOutputHandler
 */
public class IOUtils {
	/**
	 * Creates an instance of {@link org.thunlp.thulac.io.IInputProvider} which retrieves input from
	 * {@link System#in}, using the default charset as the input encoding.
	 *
	 * @return The {@link org.thunlp.thulac.io.IInputProvider} created.
	 */
	...
	/**
	 * Creates an instance of {@link org.thunlp.thulac.io.IInputProvider} which retrieves input from a given
	 * {@link java.io.InputStream} using UTF-8 as encoding.<br>
	 * It is recommended to use {@link #inputFromFile(java.io.File, java.nio.charset.Charset)} when reading
	 * input from files, since it takes better advantage of Java NIO and have better
	 * performances.
	 *
	 * @param in
	 * 		The {@link java.io.InputStream} to retrieve input from.
	 *
	 * @return The {@link org.thunlp.thulac.io.IInputProvider} created.
	 */
	...
	/**
	 * Creates an instance of {@link org.thunlp.thulac.io.IInputProvider} which retrieves input from a given
	 * {@link java.io.InputStream} using a given charset as encoding.<br>
	 * It is recommended to use {@link #inputFromFile(java.io.File, java.nio.charset.Charset)} when reading
	 * input from files, since it takes better advantage of Java NIO and have better
	 * performances.
	 *
	...
	/**
	 * Creates an instance of {@link org.thunlp.thulac.io.IInputProvider} which retrieves input from the
	 ...
	 * {@link java.io.OutputStream} using UTF-8 as encoding.<br>
	 * It is recommended to use {@link #outputToFile(java.io.File, String)} when writing
	 * output to files, since it takes better advantage of Java NIO and have better
	 * performances.
	 *
	 * @param out
	 * 		The {@link java.io.OutputStream} to write output to.
	 *
	 * @return The {@link IOutputHandler} created.
	 */
	...
	/**
	 * Creates an instance of {@link IOutputHandler} which writes output to a given
	 * {@link java.io.OutputStream} using a given charset as encoding.<br>
	 * It is recommended to use {@link #outputToFile(java.io.File, String)} when writing
	 * output to files, since it takes better advantage of Java NIO and have better
	 * performances.
	 *
	...
	/**
	 * Creates an instance of {@link org.thunlp.thulac.io.StringOutputHandler} which writes output to an
	 ...
	 * </code></pre>
	 *
	 * @return The {@link org.thunlp.thulac.io.StringOutputHandler} created.
	 */
	...
	/**
	 * Returns a {@link java.nio.charset.Charset} wich name {@code charset}. This methods differs from
	 * the {@link java.nio.charset.Charset#forName(String)} when {@code charset} is {@code null}, with
	 * this method returning {@code null} while {@link java.nio.charset.Charset#forName(String)} throws
	 * an NPE.
	 *
	 * @param charset
	 * 		The name of the {@link java.nio.charset.Charset}.
	 *
	 * @return The {@link java.nio.charset.Charset} with name {@code charset}.
	 *
	 * @throws java.nio.charset.UnsupportedCharsetException
	 * 		If the charset referred to by the given name is not supported.
	 */
	...
	/**
	 * Returns the given {@link java.nio.charset.Charset} when non-null, or
	 * {@link java.nio.charset.StandardCharsets#UTF_8} otherwise, since many applications using
	 * {@link java.nio.charset.Charset} throws NPE if charset is {@code null}.
	 *
	 * @param charset
	 * 		The given {@link java.nio.charset.Charset}.
	 *
	 * @return {@code charset} when non-null, {@link java.nio.charset.StandardCharsets#UTF_8} otherwise.
	 */
